...
import styles from "./BccdInstructors.module.css";
import Carousel from "../BccdInstructorsCarousel/BccdInstructorsCarousel";
const BccdInstructors: FunctionComponent = () => {
  return (
    <>
...
export default BccdInstructors;
