...
import styles from "./DefendersCheatSheetsService.module.css";
...
const DefendersCheatSheetsService: FunctionComponent<DetectType> = ({
  title,
  dis,
...
export default DefendersCheatSheetsService;
