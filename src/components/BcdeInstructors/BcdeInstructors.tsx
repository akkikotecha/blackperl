...
import styles from "./BcdeInstructors.module.css";
import Carousel from "../BcdeInstructorsCarousel/BcdeInstructorsCarousel";
const BcdeInstructors: FunctionComponent = () => {
  return (
    <>
...
export default BcdeInstructors;
